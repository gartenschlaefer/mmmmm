...
func getCharDescription(character: Character_Enum.Characters):
	match character:
		...
		Character_Enum.Characters.PENGUIN:
			return NotePageDetails.new(preload("uid://8n8a7j8xryrl"),"Detective Penguin", ' You are Mr. Penguin, a famous detective. The police called you as soon as they received a weird call from Mr. Mouse right before his murder. His last words were "Mr. Mouse speaking. Come fast to Mole\'s Mansion someone tries to ..." ending apruptly with a smash noise and afterwards the phone tooting. Dutifully you jumped into your sledge and drove to Mole\'s Mansion. As soon as you arrived this is what you found in the study room ...');
